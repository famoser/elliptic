 ...
 *
 * For readability, copied verbatim (except G; check the corresponding unit test).
 */
class SEC2CurveFactory
{
    ...
    public static function secp192r1(): Curve
    {
        ...
        $y = gmp_init('7192B95F FC8DA786 31011ED6 B24CDD57 3F977A11 E794811', 16);
        $G = new Point($x, $y);
    ...
    public static function secp224k1(): Curve
    {
        ...
        $x = gmp_init('A1455B33 4DF099DF 30FC28A1 69A467E9 E47075A9 0F7E650E B6B7A45C', 16);
        $y = gmp_init('7E089FED 7FBA3442 82CAFBD6 F7E319F7 C0B0BD59 E2CA4BDB 556D61A5', 16);
        $G = new Point($x, $y);
...
769FB1F7', 16);
    ...
    public static function secp224r1(): Curve
    {
        ...
        $x = gmp_init('B70E0CBD 6BB4BF7F 321390B9 4A03C1D3 56C21122 343280D6 115C1D21', 16);
        $y = gmp_init('BD376388 B5F723FB 4C22DFE6 CD4375A0 5A074764 44D58199 85007E34', 16);
        $G = new Point($x, $y);
...
00000007', 16);
        ...
        $x = gmp_init('79BE667E F9DCBBAC 55A06295 CE870B07 029BFCDB 2DCE28D9 59F2815B 16F81798', 16);
        $y = gmp_init('483ADA77 26A3C465 5DA4FBFC 0E1108A8 FD17B448 A6855419 9C47D08F FB10D4B8', 16);
        $G = new Point($x, $y);
...
27D2604B', 16);
        ...
        $x = gmp_init('6B17D1F2 E12C4247 F8BCE6E5 63A440F2 77037D81 2DEB33A0 F4A13945 D898C296', 16);
        $y = gmp_init('4FE342E2 FE1A7F9B 8EE7EB4A 7C0F9E16 2BCE3357 6B315ECE CBB64068 37BF51F5', 16);
        $G = new Point($x, $y);
...
5013875A C656398D 8A2ED19D 2A85C8ED D3EC2AEF', 16);
        ...
        $x = gmp_init('AA87CA22 BE8B0537 8EB1C71E F320AD74 6E1D3B62 8BA79B98 59F741E0 82542A38 5502F25D BF55296C 3A545E38 72760AB7', 16);
        $y = gmp_init('3617DE4A 96262C6F 5D9E98BF 9292DC29 F8F41DBD 289A147C E9DA3113 B5F0B8C0 0A60B1CE 1D7E819D 7A431D7C 90EA0E5F', 16);
        $G = new Point($x, $y);
...
3D2C34F1 EF451FD4 6B503F00', 16);
        ...
        $x = gmp_init('C6858E06 B70404E9 CD9E3ECB 662395B4 429C6481 39053FB5 21F828AF 606B4D3D BAA14B5E 77EFE759 28FE1DC1 27A2FFA8 DE3348B3 C1856A42 9BF97E7E 31C2E5BD 66', 16);
        $y = gmp_init('11839296 A789A3BC 0045C8A5 FB42C7D1 BD998F54 449579B4 46817AFB D17273E6 62C97EE7 2995EF42 640C550B 9013FAD0 761353C7 086A272C 24088BE9 4769FD16 650', 16);
        $G = new Point($x, $y);
